...
// ================================
extension _HeaderBuilder on TaxTemplate4 {
    ...
    List<pw.Widget> children = [
      pw.Expanded(
        ...
        child: await _buildLogoWithInvoiceNumber(
            ...
            data.id,
            data.date,
            TaxTemplate4.invoiceNumberFont,
            TaxTemplate4.invoiceDateFont,
            TaxTemplate4.labelFont,
            data.moduleType,
            data),
      ),
      pw.Expanded(
                ...
                child: pw.Column(
                  ...
                  children: [
                    pw.Text(
                      data.companyName,
                      style: pw.TextStyle(
                        font: TaxTemplate4.extraBoldFont,
                        fontSize: TaxTemplate4.extraBoldFontSize,
                      ),
                    ),
...
// ===============================
extension _BottomBuilder on TaxTemplate4 {
  static Future<pw.Widget> _build(InvoiceModel data) async {
    final logo =
        (data.logoBytes != null) ? pw.MemoryImage(data.logoBytes!) : null;
    final qr = (data.settings.fieldSettings.qrCode)
...
// =================================================
extension _AddressBlockBuilder on TaxTemplate4 {
      ...
      child: pw.Column(
        ...
        children: [
          pw.Text(
            ...
            style: pw.TextStyle(
              font: titleFont,
              fontSize: TaxTemplate4.titleFontSize - 2,
            ),
          ),
          data?.name == null
              ? pw.Container()
                  ...
                  children: [
                      ...
                      pw.Expanded(
                        child: pw.Text(
                          ...
                          style: pw.TextStyle(
                            font: valuesFont,
                            fontSize: TaxTemplate4.valuesFontSize,
                          ),
                        ),
                      ),
                    ]),
...
// =============================================
extension _ItemListBuilder on TaxTemplate4 {
        ...
        children: [
          pw.Expanded(
            ...
            child: pw.Text(
              ...
              textAlign: pw.TextAlign.center,
              style: pw.TextStyle(
                font: TaxTemplate4.subTitleFont,
...
// =============================================
extension _SubtotalGstBlockBuilder on TaxTemplate4 {
  static Future<pw.Widget> _build(InvoiceModel data) async {
    List titles = [];
    List values = [];
    if (data.isIgst) {
            ...
            child: pw.Text(
              ...
              style: pw.TextStyle(
                ...
                fontSize: isTotalField
                    ? TaxTemplate4.extraBoldFontSize
                    : TaxTemplate4.valuesFontSize,
...
// =============================================
extension _FooterBuilder on TaxTemplate4 {
