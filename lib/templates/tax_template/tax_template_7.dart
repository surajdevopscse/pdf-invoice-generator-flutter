        ...
        footer: (pw.Context context) {
          return pw.Container(
              ...
              child: pw.Text(
                  ...
                  style: pw.TextStyle(
                      fontFallback: [TaxTemplate7.fallbackFont], fontSize: 6)));
        },
...
// ================================
extension _HeaderBuilder on TaxTemplate7 {
  static Future<pw.Widget> _build(InvoiceModel data) async {
    ...
    List<pw.Widget> children = [
      pw.Expanded(
        ...
        child: await _buildLogoWithInvoiceNumber(
            ...
            data.id,
            data.date,
            TaxTemplate7.invoiceNumberFont,
            TaxTemplate7.invoiceDateFont,
            TaxTemplate7.labelFont,
            data.moduleType,
            data),
      ),
      pw.Expanded(
    ...
    return pw.Column(
      ...
      children: [
        pw.Column(
          ...
          children: [
            pw.Text(
              data.title.replaceAll('Tax', ''),
              textAlign: pw.TextAlign.right,
              style: pw.TextStyle(
                fontFallback: [TaxTemplate7.fallbackFont],
                color: PdfColors.blue,
                font: TaxTemplate7.titleFont,
                fontSize: TaxTemplate7.titleFontSize,
              ),
            ),
            if (moduleType != 'POR' ||
                moduleType != 'SOR' ||
              ...
              pw.Align(
                ...
                child: pw.Text(
                  ...
                  style: pw.TextStyle(
                    fontFallback: [TaxTemplate7.fallbackFont],
                    font: TaxTemplate7.labelFont,
                    fontSize: TaxTemplate7.labelFontSize,
                  ),
                ),
              ),
          ],
              ...
              child: pw.Column(
                ...
                children: [
                  pw.Text(
                    ...
                    style: pw.TextStyle(
                      fontFallback: [TaxTemplate7.fallbackFont],
                      font: TaxTemplate7.extraBoldFont,
                      fontSize: TaxTemplate7.extraBoldFontSize,
                    ),
                  ),
    ...
    //         style: pw.TextStyle(fontFallback: [TaxTemplate7.fallbackFont],
...
// ===============================
extension _BottomBuilder on TaxTemplate7 {
  static Future<pw.Widget> _build(InvoiceModel data) async {
    final logo =
        (data.logoBytes != null) ? pw.MemoryImage(data.logoBytes!) : null;
    final qr = (data.settings.fieldSettings.qrCode)
...
// =================================================
extension _AddressBlockBuilder on TaxTemplate7 {
              ...
              pw.Expanded(
                child: pw.Column(
                  ...
                  children: [
                    ...
                    //     ? pw.Text(
                    //         'Pay using UPI',
                    //         style: const pw.TextStyle(fontFallback: [TaxTemplate7.fallbackFont],
                    //           fontSize: 10,
                    //         ),
                    //       )
                    //     : pw.Container(),
        ...
        children: [
          pw.Text(
            ...
            style: pw.TextStyle(
              fontFallback: [TaxTemplate7.fallbackFont],
              font: titleFont,
              fontSize: TaxTemplate7.titleFontSize - 4,
            ),
          ),
          data?.name == null
              ? pw.Container()
      ...
      text: pw.TextSpan(
        ...
        children: [
          pw.TextSpan(
            ...
            style: pw.TextStyle(
              fontFallback: [TaxTemplate7.fallbackFont],
              font: TaxTemplate7.valuesFont,
              fontSize: TaxTemplate7.valuesFontSize,
            ),
          ),
        ],
      ),
...
// =============================================
extension _ItemListBuilder on TaxTemplate7 {
        ...
        children: [
          pw.Expanded(
            ...
            child: pw.Text(
              ...
              style: pw.TextStyle(
                fontFallback: [TaxTemplate7.fallbackFont],
                font: TaxTemplate7.subTitleFont,
                color:
          ...
          pw.Expanded(
              ...
              child: pw.Container(
                padding: const pw.EdgeInsets.only(left: 8),
                child: pw.Text(
                  isHeader ? "Amt.($currencyCode)" : model?.amount ?? "",
                  textAlign: pw.TextAlign.right,
                  style: pw.TextStyle(
                    fontFallback: [TaxTemplate7.fallbackFont],
                    font: TaxTemplate7.subTitleFont,
...
// =============================================
extension _SubtotalGstBlockBuilder on TaxTemplate7 {
  static Future<pw.Widget> _build(InvoiceModel data) async {
    final titles = [
      'Total Gross Amount:',
      'Discount:',
            ...
            child: pw.Text(
              ...
              style: pw.TextStyle(
                ...
                fontSize: isTotalField
                    ? TaxTemplate7.extraBoldFontSize
                    : TaxTemplate7.valuesFontSize,
                fontWeight: pw.FontWeight.bold,
              ),
            ),
          );
...
// =============================================
extension _FooterBuilder on TaxTemplate7 {
