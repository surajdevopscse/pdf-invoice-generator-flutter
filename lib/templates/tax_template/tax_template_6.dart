...
// ================================
extension _HeaderBuilder on TaxTemplate6 {
    ...
    List<pw.Widget> children = [
      pw.Expanded(
        ...
        child: await _buildLogoWithInvoiceNumber(
            ...
            data.id,
            data.date,
            TaxTemplate6.invoiceNumberFont,
            TaxTemplate6.invoiceDateFont,
            TaxTemplate6.labelFont,
            data.moduleType,
            data),
      ),
      pw.Expanded(
            ...
            pw.Column(
              ...
              children: [
                pw.Text(
                  data.companyName,
                  style: pw.TextStyle(
                    font: TaxTemplate6.extraBoldFont,
                    fontSize: TaxTemplate6.extraBoldFontSize,
                  ),
                ),
              ...
              children: [
                pw.Text(
                  ...
                  style: pw.TextStyle(
                    ...
                    font: TaxTemplate6.titleFont,
                    fontSize: TaxTemplate6.titleFontSize,
                  ),
                ),
                if (moduleType != 'POR' ||
                    moduleType != 'SOR' ||
                  ...
                  pw.Align(
                    ...
                    child: pw.Text(
                      ...
                      style: pw.TextStyle(
                        font: TaxTemplate6.labelFont,
                        fontSize: TaxTemplate6.labelFontSize,
                      ),
                    ),
                  ),
                customLabelValue(
...
// ===============================
extension _BottomBuilder on TaxTemplate6 {
  static Future<pw.Widget> _build(InvoiceModel data) async {
    final logo =
        (data.logoBytes != null) ? pw.MemoryImage(data.logoBytes!) : null;
    final qr = (data.settings.fieldSettings.qrCode)
...
// =================================================
extension _AddressBlockBuilder on TaxTemplate6 {
      ...
      child: pw.Column(
        ...
        children: [
          pw.Text(
            ...
            style: pw.TextStyle(
              font: titleFont,
              fontSize: TaxTemplate6.titleFontSize - 2,
            ),
          ),
          data?.name == null
              ? pw.Container()
                  ...
                  children: [
                      ...
                      pw.Expanded(
                        child: pw.Text(
                          ...
                          style: pw.TextStyle(
                            font: valuesFont,
                            fontSize: TaxTemplate6.valuesFontSize,
                          ),
                        ),
                      ),
                    ]),
...
// =============================================
extension _ItemListBuilder on TaxTemplate6 {
        ...
        children: [
          pw.Expanded(
            ...
            child: pw.Text(
              ...
              textAlign: pw.TextAlign.center,
              style: pw.TextStyle(
                font: TaxTemplate6.subTitleFont,
...
// =============================================
extension _SubtotalGstBlockBuilder on TaxTemplate6 {
  static Future<pw.Widget> _build(InvoiceModel data) async {
    final titles = [
      'Total Gross Amount:',
      'Discount:',
            ...
            child: pw.Text(
              ...
              style: pw.TextStyle(
                ...
                fontSize: isTotalField
                    ? TaxTemplate6.extraBoldFontSize
                    : TaxTemplate6.valuesFontSize,
...
// =============================================
extension _FooterBuilder on TaxTemplate6 {
