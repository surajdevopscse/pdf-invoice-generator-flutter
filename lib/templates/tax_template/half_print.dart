                        ...
                        child: pw.Column(
                            ...
                            children: [
                              ...
                              pw.Text(
                                ...
                                textAlign: pw.TextAlign.right,
                                style: pw.TextStyle(
                                  font: HalfPrint.extraBoldFont,
                                  color: PdfColors.black,
                                  fontSize: HalfPrint.extraBoldFontSize,
                                ),
                              ),
                            ])),
                  ),
...
extension _HeaderBuilder on HalfPrint {
        ...
        child: pw.Row(children: [
          ...
          pw.Expanded(
              ...
              child: pw.Center(
                ...
                data.title,
                style: pw.TextStyle(
                    fontSize: HalfPrint.titleFontSize,
          ...
          pw.Expanded(
              ...
              child: pw.Container(
                  ...
                  child: pw.Text(
                    data.printCopyTitle,
                    style: pw.TextStyle(
                        fontSize: HalfPrint.valuesFontSize,
                        fontWeight: pw.FontWeight.normal,
                        color: PdfColor.fromInt(data.settings.textColor.value)),
                  ))),
        ]));
...
extension _BottomBuilder on HalfPrint {
  static Future<pw.Widget> _build(InvoiceModel data) async {
    final logo =
...
extension _AddressBlockBuilder on HalfPrint {
                    ...
                    child: pw.Column(
                      ...
                      children: [
                        pw.Text(
                          ...
                          style: pw.TextStyle(
                            font: titleFont,
                            fontSize: HalfPrint.titleFontSize - 2,
                        ...
                        if (data.settings.fieldSettings.gstin)
                          customLabelValue(
                            label: '${data.taxLabel} : ',
                            value: data.companyGST,
                          ),
                        ...
                        data.buyer.billingAddress!.gstLabel == null
                            ...
                            : pw.Row(children: [
                                pw.Text(
                                  ...
                                  style: pw.TextStyle(
                                    font: labelFont,
                                    fontSize: HalfPrint.labelFontSize,
                                  ),
                                ),
...
extension _AdditionalBlockBuilder on HalfPrint {
                      ...
                      child: pw.Column(
                        ...
                        children: [
                          pw.Text(
                            ...
                            style: pw.TextStyle(
                              font: titleFont,
                              fontSize: HalfPrint.valuesFontSize + 2,
                              fontWeight: pw.FontWeight.bold,
                            ),
                          ),
                          pw.Text(
...
extension _ItemListBuilder on HalfPrint {
                  ...
                  (index) {
                    {
                      ...
                      double halfGstAmount = (double.tryParse(
                              ...
                              0) /
                          2;
                      if (data.hsnItems.length - 1 != index) {
                        return pw.TableRow(
                          decoration: pw.BoxDecoration(
                              border: pw.Border.all(width: borderWidth)),
                          children: [
                              ...
                              child: pw.Text(
                                ...
                                style: pw.TextStyle(
                                  font: hsnData.hsnCode == 'Total'
                                      ? HalfPrint.labelFont
                                      : HalfPrint.valuesFont,
                                  fontSize: hsnData.hsnCode == 'Total'
                                      ? HalfPrint.labelFontSize
                                      : HalfPrint.valuesFontSize,
...
extension _SubtotalGstBlockBuilder on HalfPrint {
  static Future<pw.Widget> _build(InvoiceModel data) async {
    final titles = [
...
extension _FooterBuilder on HalfPrint {
