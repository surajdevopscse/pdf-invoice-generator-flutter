...
// ================================
extension _HeaderBuilder on TaxTemplate2 {
  static Future<pw.Widget> _build(InvoiceModel data) async {
    ...
    List<pw.Widget> children = [
      pw.Expanded(
        ...
        child: await _buildLogoWithInvoiceNumber(
            ...
            data.id,
            data.date,
            TaxTemplate2.invoiceNumberFont,
            TaxTemplate2.invoiceDateFont,
            TaxTemplate2.labelFont,
            data.moduleType,
            data),
      ),
        ...
        child: pw.Column(
            ...
            children: [
              pw.Text(
                ...
                style: pw.TextStyle(
                  font: TaxTemplate2.titleFont,
                  fontSize: TaxTemplate2.titleFontSize,
              ...
              if (moduleType != 'POR' ||
                  moduleType != 'SOR' ||
                  moduleType != 'SQU')
                customLabelValue(label: data.printCopyTitle, value: ''),
              pw.SizedBox(height: 2),
              customLabelValue(
                label: '$label No: ',
                value: invoiceNumber,
    ...
    //         style: pw.TextStyle(
    //           font: TaxTemplate2.labelFont,
    //           fontSize: TaxTemplate2.labelFontSize,
    //         ),
    //       ),
    //     ),
    //   ]),
    ...
    return pw.Column(
      ...
      children: [
        pw.Text(data.companyName,
            style: pw.TextStyle(
                font: TaxTemplate2.extraBoldFont,
                fontSize: TaxTemplate2.extraBoldFontSize)),
...
// ===============================
extension _BottomBuilder on TaxTemplate2 {
  static Future<pw.Widget> _build(InvoiceModel data) async {
    final logo =
        (data.logoBytes != null) ? pw.MemoryImage(data.logoBytes!) : null;
    final qr = (data.settings.fieldSettings.qrCode)
...
// =================================================
extension _AddressBlockBuilder on TaxTemplate2 {
      ...
      child: pw.Column(
        ...
        children: [
          pw.Text(
            ...
            style: pw.TextStyle(
              font: titleFont,
              fontSize: TaxTemplate2.titleFontSize - 2,
            ),
          ),
          data?.name == null
              ? pw.Container()
                  ...
                  children: [
                      ...
                      pw.Expanded(
                        child: pw.Text(
                          ...
                          style: pw.TextStyle(
                            font: valuesFont,
                            fontSize: TaxTemplate2.valuesFontSize,
                          ),
                        ),
                      ),
                    ]),
...
extension _AdditionalFieldBlockBuilder on TaxTemplate2 {
  static Future<pw.Row> _build(InvoiceModel data) async {
    final titleFont = await PdfGoogleFonts.mulishBold();
    final labelFont = await PdfGoogleFonts.mulishSemiBold();
    final valuesFont = await PdfGoogleFonts.mulishRegular();
                    ...
                    child: pw.Column(
                      ...
                      children: [
                        pw.Text(
                          ...
                          style: pw.TextStyle(
                            font: titleFont,
                            fontSize: TaxTemplate2.valuesFontSize + 2,
...
// =============================================
extension _ItemListBuilder on TaxTemplate2 {
        ...
        children: [
          pw.Expanded(
            ...
            child: pw.Text(
              ...
              textAlign: pw.TextAlign.center,
              style: pw.TextStyle(
                font: TaxTemplate2.subTitleFont,
      ...
      children: [
        pw.Row(
          ...
          children: [
            ...
            pw.Container(
              child: pw.Text(
                "Total Amount (in Words): $amount Only",
                maxLines: 2,
                style: pw.TextStyle(
                  color: PdfColors.black,
                  fontSize: TaxTemplate2.extraBoldFontSize,
                            ...
                            child: pw.Text(
                              ...
                              style: pw.TextStyle(
                                font: hsnData.hsnCode == 'Total'
                                    ? TaxTemplate2.labelFont
                                    : TaxTemplate2.valuesFont,
                                fontSize: hsnData.hsnCode == 'Total'
                                    ? TaxTemplate2.labelFontSize
                                    : TaxTemplate2.valuesFontSize,
...
// =============================================
extension _SubtotalGstBlockBuilder on TaxTemplate2 {
  static Future<pw.Widget> _build(InvoiceModel data) async {
    final titles = [
            ...
            child: pw.Text(
              ...
              style: pw.TextStyle(
                ...
                fontSize: isTotalField
                    ? TaxTemplate2.extraBoldFontSize
                    : TaxTemplate2.valuesFontSize,
                fontWeight: pw.FontWeight.bold,
              ),
            ),
...
// =============================================
extension _FooterBuilder on TaxTemplate2 {
